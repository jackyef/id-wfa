...
export const getJobOpenings = async (): Promise<JobOpening[]> => {
  ...
  const response = await fetch('https://glints.com/api/graphql', {
    ...
    body: '{"operationName":"searchJobs","variables":{"data":{"isRemote":true,"CompanyId":["58581036-8b82-4e86-b75f-b8e57ef544ad"],"JobCategoryId":[1],"limit":30,"offset":0,"prioritiseHotJobs":true,"includeExternalJobs":true,"sources":["NATIVE","SUPER_POWERED"]}},"query":"query searchJobs($data: JobSearchConditionInput!) {\\n  searchJobs(data: $data) {\\n    jobsInPage {\\n      id\\n      title\\n      isRemote\\n      status\\n      createdAt\\n      isActivelyHiring\\n      isHot\\n      salaryEstimate {\\n        minAmount\\n        maxAmount\\n        CurrencyCode\\n        __typename\\n      }\\n      company {\\n        ...CompanyFields\\n        __typename\\n      }\\n      citySubDivision {\\n        id\\n        name\\n        __typename\\n      }\\n      city {\\n        ...CityFields\\n        __typename\\n      }\\n      country {\\n        ...CountryFields\\n        __typename\\n      }\\n      category {\\n        id\\n        name\\n        __typename\\n      }\\n      salaries {\\n        ...SalaryFields\\n        __typename\\n      }\\n      minYearsOfExperience\\n      maxYearsOfExperience\\n      source\\n      __typename\\n    }\\n    totalJobs\\n    __typename\\n  }\\n}\\n\\nfragment CompanyFields on Company {\\n  id\\n  name\\n  logo\\n  __typename\\n}\\n\\nfragment CityFields on City {\\n  id\\n  name\\n  __typename\\n}\\n\\nfragment CountryFields on Country {\\n  code\\n  name\\n  __typename\\n}\\n\\nfragment SalaryFields on JobSalary {\\n  id\\n  salaryType\\n  salaryMode\\n  maxAmount\\n  minAmount\\n  CurrencyCode\\n  __typename\\n}\\n"}',
    method: 'POST',
  });
