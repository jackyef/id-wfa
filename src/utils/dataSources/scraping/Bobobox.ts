...
export const getJobOpenings = async (): Promise<JobOpening[]> => {
  ...
  const response = await fetch('https://glints.com/api/graphql', {
    ...
    body: '{"operationName":"searchJobs","variables":{"data":{"CompanyId":["00e32ac6-95b0-4723-8dc2-f3a32f1d884d"],"JobCategoryId":[1,3],"limit":30,"offset":0,"prioritiseHotJobs":true,"includeExternalJobs":true,"variant":"A","sources":["NATIVE","SUPER_POWERED"],"searchVariant":"JOB_TITLE"}},"query":"query searchJobs($data: JobSearchConditionInput!) {\\n  searchJobs(data: $data) {\\n    jobsInPage {\\n      id\\n      title\\n      isRemote\\n      status\\n      createdAt\\n      isActivelyHiring\\n      isHot\\n      salaryEstimate {\\n        minAmount\\n        maxAmount\\n        CurrencyCode\\n        __typename\\n      }\\n      company {\\n        ...CompanyFields\\n        __typename\\n      }\\n      citySubDivision {\\n        id\\n        name\\n        __typename\\n      }\\n      city {\\n        ...CityFields\\n        __typename\\n      }\\n      country {\\n        ...CountryFields\\n        __typename\\n      }\\n      category {\\n        id\\n        name\\n        __typename\\n      }\\n      salaries {\\n        ...SalaryFields\\n        __typename\\n      }\\n      minYearsOfExperience\\n      maxYearsOfExperience\\n      source\\n      __typename\\n    }\\n    totalJobs\\n    __typename\\n  }\\n}\\n\\nfragment CompanyFields on Company {\\n  id\\n  name\\n  logo\\n  __typename\\n}\\n\\nfragment CityFields on City {\\n  id\\n  name\\n  __typename\\n}\\n\\nfragment CountryFields on Country {\\n  code\\n  name\\n  __typename\\n}\\n\\nfragment SalaryFields on JobSalary {\\n  id\\n  salaryType\\n  salaryMode\\n  maxAmount\\n  minAmount\\n  CurrencyCode\\n  __typename\\n}\\n"}',
    method: 'POST',
  });
